...
export function App() {
    ...
    const onDelete = async(data) => {
        await fetch("http://localhost:3000/post/" + data, {
                method: "DELETE"
            }).then((res) => console.log(res));
        setImages(images.filter((e) => e._id !== data));
    };
